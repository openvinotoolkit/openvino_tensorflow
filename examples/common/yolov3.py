...
def get_yolo3_model(weights_path, model_type, num_feature_layers, num_anchors, num_classes, input_tensor=None, input_shape=None, model_pruning=False, pruning_end_step=10000):
...
def load_model(weights_path, num_anchors, num_classes, image_size):
    ...
    try:
        yolo_model, _ = get_yolo3_model(weights_path,'yolo3_darknet', num_feature_layers, num_anchors, num_classes, input_shape=image_size+ (3,), model_pruning=False)
        print ("model loaded")
