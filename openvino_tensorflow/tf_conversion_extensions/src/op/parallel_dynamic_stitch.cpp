...
OutputVector translate_parallel_dynamic_stitch_op(const ov::frontend::NodeContext& node) {
    ...
    for (int i = 0; i < N; ++i) {
        ...
        //std::cout << "OV_DEBUG - TFFE - translate_parallel_dynamic_stitch_op - shape: " << indices.get_shape() << std::endl;
