...
void IE_Basic_Engine::infer(
  ...
  if (std::getenv("OPENVINO_TF_ENABLE_INFERENCE_TIMING")) {
    ...
    OVTF_VLOG(1) << "OVTF_LOAD_NETWORK_TIME: " << duration_in_ms << " ms" << std::endl;
  }
  ...
  if (std::getenv("OPENVINO_TF_ENABLE_INFERENCE_TIMING")) {
    int64_t duration_in_ms = (GetCurrentTimeNanos() - start_ns) / 1e6;
    OVTF_VLOG(1) << "OVTF_CREATE_REQUEST_TIME: " << duration_in_ms << " ms" << std::endl;
  }
  ...
  if (std::getenv("OPENVINO_TF_ENABLE_INFERENCE_TIMING")) {
    int64_t duration_in_ms = (GetCurrentTimeNanos() - start_ns) / 1e6;
    OVTF_VLOG(1) << "OVTF_INPUTS_SET_TIME: " << duration_in_ms << " ms" << std::endl;
  }
  ...
  if (std::getenv("OPENVINO_TF_ENABLE_INFERENCE_TIMING")) {
    int64_t duration_in_ms = (GetCurrentTimeNanos() - start_ns) / 1e6;
    OVTF_VLOG(1) << "OVTF_PARAMS_SET_TIME: " << duration_in_ms << " ms" << std::endl;
  }
  ...
  if (std::getenv("OPENVINO_TF_ENABLE_INFERENCE_TIMING")) {
    int64_t duration_in_ms = (GetCurrentTimeNanos() - start_ns) / 1e6;
    OVTF_VLOG(1) << "OVTF_OUTPUTS_SET_TIME: " << duration_in_ms << " ms" << std::endl;
  }
  ...
  if (std::getenv("OPENVINO_TF_ENABLE_INFERENCE_TIMING")) {
    int64_t duration_in_ms = (GetCurrentTimeNanos() - start_ns) / 1e6;
    OVTF_VLOG(1) << "OVTF_INFERENCE_TIME: " << duration_in_ms << " ms" << std::endl;
  }
  ...
  if (std::getenv("OPENVINO_TF_ENABLE_INFERENCE_TIMING")) {
    int64_t duration_in_ms = (GetCurrentTimeNanos() - start_ns) / 1e6;
    OVTF_VLOG(1) << "OVTF_DYNAMIC_OUTPUT_SET_TIME: " << duration_in_ms << " ms" << std::endl;
  }
