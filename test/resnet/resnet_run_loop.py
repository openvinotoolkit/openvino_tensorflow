...
import parsers  # pylint: disable=g-bad-import-order
import hooks_helper
import resnet_model
...
def resnet_model_fn(features, labels, mode, model_class,
                    ...
                    data_format, version, loss_filter_fn=None, multi_gpu=False,select_device='NGRAPH'):
...
def resnet_main(flags, model_function, input_function):
  ...
  classifier = tf.estimator.Estimator(
      ...
      params={
          ...
          'select_device' :flags.select_device
      })
...
class ResnetArgParser(argparse.ArgumentParser):
  ...
  def __init__(self, resnet_size_choices=None):
    ...
    self.add_argument(
        '--select_device', '-sd', type=str, default='NGRAPH',
        help='Enter device to place the computation on',
    )
