...
def get_logging_tensor_hook(every_n_iter=1, **kwargs):  # pylint: disable=unused-argument
...
def get_examples_per_second_hook(every_n_steps=100,
  ...
  Returns:
    ...
    profiling tools like chrome://tracing.
  """
  return hooks.ExamplesPerSecondHook(every_n_steps=1,#every_n_steps,
