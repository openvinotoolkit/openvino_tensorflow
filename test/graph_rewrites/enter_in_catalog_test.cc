...
// Graph with one Assign op which should have the attribute
// _ngraph_remove added to it and set to true
TEST(CatalogTest, SmallGraph1) {
  ...
  ASSERT_OK(RewriteForTracking(&graph, 0));
