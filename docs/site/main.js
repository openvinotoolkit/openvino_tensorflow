const combination = new Map([
    ...
    ["000001", " pip3 install -U pip,pip3 install tensorflow==2.8.0,pip3 -U install openvino-tensorflow"],
    ["000101", " pip3 install -U pip,pip3 install tensorflow==2.8.0,pip3 -U install openvino-tensorflow"],
    ...
    ["001101", " pip3 install -U pip,pip3 install tensorflow==2.8.0,pip3 -U install openvino-tensorflow"],
    ...
    ["100010", " #Use OpenVINO 2022.1,python3 build_ovtf.py --use_openvino_from_location=$INTEL_OPENVINO_DIR --cxx11_abi_version=1"],
    ["100110", " #Use OpenVINO 2022.1,python3 build_ovtf.py --use_openvino_from_location=$INTEL_OPENVINO_DIR --cxx11_abi_version=1"],
