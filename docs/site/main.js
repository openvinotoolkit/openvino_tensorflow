const combination = new Map([
    ["000000", " pip3 install -U pip, pip3 install tensorflow==2.9.2, pip3 install openvino-tensorflow==2.2.0, Download Intel® Distribution of OpenVINO™ Toolkit Link-https://software.intel.com/content/www/us/en/develop/tools/openvino-toolkit/download.html?operatingsystem=linux&distributions=webdownload&version=2021%203%20(latest)&options=offline , source $INTEL_OPENVINO_DIR/setupvars.sh"],
    ["000100", " pip3 install -U pip, pip3 install tensorflow==2.9.2, pip3 install openvino-tensorflow==2.2.0, Download Intel® Distribution of OpenVINO™ Toolkit Link-https://software.intel.com/content/www/us/en/develop/tools/openvino-toolkit/download.html?operatingsystem=linux&distributions=webdownload&version=2021%203%20(latest)&options=offline , source $INTEL_OPENVINO_DIR/setupvars.sh"],
    ["001000", " Windows not yet supported for VAD-M"],
    ["001100", " Mac OS not yet supported for VAD-M"],
    ["000001", " pip3 install -U pip, pip3 install tensorflow==2.9.2, pip3 install openvino-tensorflow==2.2.0"],
    ["000101", " pip3 install -U pip,pip3 install tensorflow==2.9.2,pip3 install openvino-tensorflow==2.2.0"],
    ["001001", " pip3 install -U pip,pip3 install https://github.com/openvinotoolkit/openvino_tensorflow/releases/download/v2.2.0/tensorflow-2.9.2-cp39-cp39-win_amd64.whl, pip3 install openvino-tensorflow==2.2.0"],
    ["001101", " pip3 install -U pip,pip3 install tensorflow==2.9.2,pip3 install openvino-tensorflow==2.2.0"],
    ["010001", " pip3 install openvino-tensorflow==2.2.0"],
    ["010101", " pip3 install openvino-tensorflow==2.2.0"],
    ["011001", " OpenVINO™ integration with TensorFlow doesn't supports PyPi TensorFlow download TensorFlow from the Github release assets, pip3 install https://github.com/openvinotoolkit/openvino_tensorflow/releases/download/v2.2.0/tensorflow-2.9.2-cp39-cp39-win_amd64.whl, pip3 install openvino-tensorflow==2.2.0", ],
    ["011101", " pip3 install openvino-tensorflow==2.2.0"],
    ["100000", " pip3 install -U pip, pip3 install tensorflow==2.9.2, pip3 install openvino-tensorflow==2.2.0, source $INTEL_OPENVINO_DIR/setupvars.sh"],
    ["100100", " pip3 install -U pip, pip3 install tensorflow==2.9.2, pip3 install openvino-tensorflow==2.2.0 , source $INTEL_OPENVINO_DIR/setupvars.sh"],
    ["101000", " Windows not yet supported for VAD-M"],
    ["101100", " Mac OS not yet supported for VAD-M"],
    ["000010", " Download Intel® Distribution of OpenVINO™ Toolkit Link-https://software.intel.com/content/www/us/en/develop/tools/openvino-toolkit/download.html?operatingsystem=linux&distributions=webdownload&version=2021%203%20(latest)&options=offline ,python3 build_ovtf.py --use_openvino_from_location=$INTEL_OPENVINO_DIR --tf_version=v2.9.2"],
    ...
    ["001011", " Build from source on Windows needs Intel® Distribution of OpenVINO™ Toolkit , python build_ovtf.py --tf_version=v2.9.2 --use_openvino_from_location=$INTEL_OPENVINO_DIR "],
