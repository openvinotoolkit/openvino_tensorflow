...
if __name__ == "__main__":
    ...
    python ovtf_graph_viewer.py pbtxtfile.pbtxt ./vis  # read pbtxt and generate TB
    python ovtf_graph_viewer.py -v 1 pbtxtfile.pbtxt ./vis  # read pbtxt and generate dot
    python ovtf_graph_viewer.py -b pbtxtfile.pb ./vis  # read pb and generate TB
    python ovtf_graph_viewer.py -b -v 1 pbtxtfile.pb ./vis  # read pb and generate dot
    python ovtf_graph_viewer.py -c nodemap.pkl pbtxtfile.pbtxt ./vis  # read pbtxt, remap node names and generate TB
