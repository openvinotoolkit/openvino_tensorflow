...
#ifndef TENSORFLOW_COMPILER_NGRAPH_DRIVER_NGRAPH_UTILS_H_
#define TENSORFLOW_COMPILER_NGRAPH_DRIVER_NGRAPH_UTILS_H_
...
#endif  // TENSORFLOW_COMPILER_NGRAPH_DRIVER_NGRAPH_UTILS_H_
